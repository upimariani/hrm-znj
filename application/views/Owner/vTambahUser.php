    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form action="<?= base_url('Owner/cUser/create') ?>" method="POST">
                    <div class="form-group">
                        <label>Nama User</label>
                        <input class="form-control" name="nama" value="<?= set_value('nama') ?>" type="text" placeholder="Masukkan Nama User">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?= set_value('no_hp') ?>" name="no_hp" type="text" placeholder="Masukkan No Telepon">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" value="<?= set_value('username') ?>" name="username" type="text" placeholder="Masukkan Username">
                        <?= form_error('username', ' <small class="form-text text-muted">', '</small>') ?>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input class="form-control" value="<?= set_value('password') ?>" name="password" type="text" placeholder="Masukkan Password">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="level_user" style="width: 100%; height: 38px;">
                            ...
                            <option value="1" <?php if (set_value('level_user') == '1') {
                                                    echo 'selected';
                                                } ?>>Admin</option>
                            <option value="2" <?php if (set_value('level_user') == '2') {
                                                    echo 'selected';
                                                } ?>>Owner</option>
                        </select>
